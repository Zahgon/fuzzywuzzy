...
/**
 * Frozen Unicode data extracted from the CPython interpreter that runs the reference
 * implementation, so that this port cannot drift when the JDK ships newer Unicode tables.
 *
 * <p>Generated by {@code tools/generate_unicode_tables.py} against CPython 3.14.7
 * (unicodedata 16.0.0), the interpreter in the source repository's virtualenv.
 *
 * <p>This matters in practice. OpenJDK 26 carries a later Unicode revision than CPython 3.14, so
 * {@link Character#getType(int)} reports code points such as U+088F, U+0C5C, U+A7CE and
 * U+10940..U+10950 as letters while Python still treats them as unassigned. Using the JDK's own
 * tables would therefore make {@code full_process} disagree with the reference implementation on
 * those inputs.
 */
final class UnicodeTables {
    ...
    /**
     * Inclusive {@code [lo, hi]} pairs of code points matched by Python's {@code re} {@code \w}
     * under the UNICODE flag, i.e. general categories {@code Lu Ll Lt Lm Lo Nd Nl No} plus
     * {@code U+005F LOW LINE}. Flattened and sorted, so membership is a binary search.
     */
    static final int[] WORD_RANGES = {
            0x0030, 0x0039, 0x0041, 0x005A, 0x005F, 0x005F, 0x0061, 0x007A,
            0x00AA, 0x00AA, 0x00B2, 0x00B3, 0x00B5, 0x00B5, 0x00B9, 0x00BA,
            0x00BC, 0x00BE, 0x00C0, 0x00D6, 0x00D8, 0x00F6, 0x00F8, 0x02C1,
            ...
            0x06D5, 0x06D5, 0x06E5, 0x06E6, 0x06EE, 0x06FC, 0x06FF, 0x06FF,
            0x0710, 0x0710, 0x0712, 0x072F, 0x074D, 0x07A5, 0x07B1, 0x07B1,
            0x07C0, 0x07EA, 0x07F4, 0x07F5, 0x07FA, 0x07FA, 0x0800, 0x0815,
            ...
            0x09E6, 0x09F1, 0x09F4, 0x09F9, 0x09FC, 0x09FC, 0x0A05, 0x0A0A,
            ...
            0x0EC0, 0x0EC4, 0x0EC6, 0x0EC6, 0x0ED0, 0x0ED9, 0x0EDC, 0x0EDF,
            0x0F00, 0x0F00, 0x0F20, 0x0F33, 0x0F40, 0x0F47, 0x0F49, 0x0F6C,
